 ...
 * 
 */
public class StorageLocalCacheFindValueOperation extends FindValueOperation implements CompletionHandler<KadMessage, Node> {
	...
	@Inject
	StorageLocalCacheFindValueOperation(@Named("openkad.local.node") final Node localNode,
