 ...
 * 
 */
public class EagerColorFindValueOperationStorage extends FindValueOperation implements CompletionHandler<KadMessage, Node> {
	...
	@Inject
	EagerColorFindValueOperationStorage(@Named("openkad.local.node") final Node localNode,
	...
	public List<Node> doFindValue() {
		...
		else if (this.returnedCachedResults == null) {
